...
NoClipBtn.MouseButton1Down:Connect(function()
	...
	if _G.infinJumpStarted == nil then
		...
		game.StarterGui:SetCore("SendNotification", {Title="Hve Fun"; Text="Infinite Jump is ready!"; Duration=5;})
...
NoClipBtn_4.MouseButton1Down:Connect(function()
...
local function JPEH_fake_script() 
...
coroutine.wrap(JPEH_fake_script)()
local function IBLHI_fake_script() -- ScreenGui.CloseGUI 
	local script = Instance.new('LocalScript', ScreenGui)
